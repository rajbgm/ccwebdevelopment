	...
	class Notifications {
		...
		public static function init() {
			if ( \is_admin() ) {
				...
				\add_action( 'wp_ajax_wsal_send_notifications_test_slack', array( Notification_Helper::class, 'send_test_slack' ) );
		...
		public static function header() {
			...
			// phpcs:enable
			\wp_enqueue_style(
				'wsal-query-builder-style',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/external/query-builder/dist/css/query-builder.default.css',
				array(),
				WSAL_VERSION
			);

			\wp_enqueue_script(
				'wsal-popover-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/popper.min.js',
				array( 'jquery' ),
				WSAL_VERSION,
				true
			);
			...
			\wp_enqueue_script(
				'wsal-bootstrap-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/bootstrap.min.js',
				array( 'jquery', 'wsal-popover-query-builder' ),
				WSAL_VERSION,
				true
			);

			\wp_enqueue_script(
				'wsal-moment-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/moment.min.js',
				array( 'jquery' ),
				WSAL_VERSION,
				true
			);
			...
			\wp_enqueue_script(
				'wsal-bootstrap-datapicker-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/bootstrap-datepicker.min.js',
				array( 'jquery' ),
				WSAL_VERSION,
				true
			);
			...
			\wp_enqueue_script(
				'wsal-bootstrap-slider-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/bootstrap-slider.min.js',
				array( 'jquery' ),
				WSAL_VERSION,
				true
			);
			...
			\wp_enqueue_script(
				'wsal-selectize-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/selectize.min.js',
				array( 'jquery' ),
				WSAL_VERSION,
				true
			);
			...
			// \wp_enqueue_script(
			// 'wsal-bootstrap-select-query-builder',
			// WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/bootstrap-select.min.js',
			// array( 'jquery', 'wsal-bootstrap-query-builder' ),
			// WSAL_VERSION,
			// true
			// );
			...
			\wp_enqueue_script(
				'wsal-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/external/query-builder/dist/js/query-builder.standalone.js',
				array( 'jquery', 'wsal-bootstrap-query-builder' ),
				WSAL_VERSION,
				true
			);
			...
			\wp_enqueue_script(
				'wsal-sql-parser-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/sql-parser.min.js',
				array( 'jquery' ),
				WSAL_VERSION,
				true
			);
			...
			\wp_enqueue_script(
				'wsal-interact-query-builder',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/js/interact.min.js',
				array( 'jquery' ),
				WSAL_VERSION,
				true
			);
			...
			\wp_enqueue_style(
				'wsal-bootstrap-query-builder-style',
				WSAL_BASE_URL . 'classes/Helpers/settings/admin/css/bootstrap.min.css',
				array(),
				WSAL_VERSION,
			);
			// phpcs:disable
		...
		public static function content_show() {
			...
			$settings_tabs = array(
				...
				/* @premium:start */
				// phpcs:enable
				'wordpress-notifications'   => array(
					'icon'  => 'wordpress',
					'title' => \esc_html__( 'WordPress notifications', 'wp-security-audit-log' ),
				),
				// phpcs:disable
				/* @premium:end */
				// phpcs:enable
				...
				'custom-notification-edit'  => array(
					'icon'  => 'admin-generic',
					'title' => \esc_html__( 'Settings', 'wp-security-audit-log' ),
				),
				// phpcs:disable
